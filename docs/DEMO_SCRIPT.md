...
- **Title:** "Welcome to IRconnect. Investor targeting, AI script generation, roadshows, and meeting prep — in one place." *(TTS: spell "I.R." so it reads "I‑R"; card tagline: "Investor targeting · AI script generation · roadshows · meeting prep".)*
...
- **9 · Script generation:** "And it doesn't stop at roadshows. When earnings come, the script drafts itself — every section, generated by AI and shown side-by-side with the live analytics, so the whole team works from one source." *(Earnings Cycle → Script Generation → Script Canvas — the RAISED guidance decision + section nav + AI trend-read shown side-by-side.)*
- **10 · Closing card (finale):** "See it on your own book. Contact us today — rob at praxis point I‑R dot com." *(Branded closing: lighthouse + wordmark, "Contact us today", rob@praxispointir.com in gold.)*

> Trimmed cut (for cold email) drops the per-trip "Who to see" targets scene — the metro table already makes the ranked-targets point — and tightens every narration; runtime ~1:34.
